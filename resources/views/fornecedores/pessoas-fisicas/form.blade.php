<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link active" id="tabs-dados-fornecedor-tab" data-toggle="pill" href="#tabs-dados-fornecedor"
            role="tab" aria-controls="tabs-dados-fornecedor" aria-selected="true">Dados do Fornecedor</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content" id="tabs-tabContent">
    ...
    <div class="tab-pane fade show active" id="tabs-dados-fornecedor" role="tabpanel"
        ...
        <div class="form card card-body" id="form-dados-fornecedor">
            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            {!! Form::text('cpf', isset($fornecedor) ? $fornecedor->pessoa->pessoaFisica->cpf : null, [
                ...
                <div class="col-xs-8 col-sm-8 col-md-8">
                    <div class="form-group">
                        ...
                        {!! Form::text('nome', isset($fornecedor) ? $fornecedor->pessoa->pessoaFisica->nome : null, [
                            'class' => 'form-control',
                            'id' => 'nome',
                        ]) !!}
                    </div>
            ...
            <div class="row">
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('rg', isset($fornecedor) ? $fornecedor->pessoa->pessoaFisica->rg : null, [
                            'class' => 'form-control',
                            'id' => 'rg',
                        ]) !!}
                    </div>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text('rg_orgao', isset($fornecedor) ? $fornecedor->pessoa->pessoaFisica->rg_orgao : null, [
                            'class' => 'form-control',
                            'id' => 'rg-orgao',
                        ]) !!}
                    </div>
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="form-group">
                        ...
                        {!! Form::text(
                            'rg_emissao',
                            isset($fornecedor) ? \Carbon\Carbon::parse($fornecedor->pessoa->pessoaFisica->rg_emissao)->format('d/m/Y') : null,
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text(
                            'nascimento',
                            isset($fornecedor) ? \Carbon\Carbon::parse($fornecedor->pessoa->pessoaFisica->nascimento)->format('d/m/Y') : null,
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::select(
                            ...
                            isset($fornecedor) ? $fornecedor->pessoa->pessoaFisica->sexo : old('sexo'),
            ...
            <!-- Fim da tab Dados do Fornecedor -->
        </div>
    </div>
    <!-- Tab Dados Bancários -->
