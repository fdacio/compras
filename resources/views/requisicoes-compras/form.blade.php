    ...
    <div class="row">
        <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
                ...
                {!! Form::select('tipo', $tipos, isset($requisicao) ? $requisicao->tipo : old('tipo'), [
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select(
                    'id_requisitante',
                    $requisitantes,
                    isset($requisicao) ? $requisicao->id_requisitante : old('id_requisitante'),
                    [
                        'placeholder' => 'Selecione',
                        'class' => 'form-control select',
                        'id' => 'id_requisitante',
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select(
                    'id_solicitante',
                    $solicitantes,
                    isset($requisicao) ? $requisicao->id_solicitante : old('id_solicitante'),
                    [
                        'placeholder' => 'Selecione',
                        'class' => 'form-control select',
                        'id' => 'id_solicitante',
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::select('id_veiculo', $veiculos, isset($requisicao) ? $requisicao->id_veiculo : old('id_veiculo'), [
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::textarea('local_entrega', isset($requisicao) ? $requisicao->local_entrega : old('local_entrega'), [
                    'class' => 'form-control',
                    'rows' => 2,
                    'id' => 'local-entrega',
                ]) !!}
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::textarea('observacao', isset($requisicao) ? $requisicao->observacao : old('observacao'), [
                    'class' => 'form-control',
                    'rows' => 2,
                    'id' => 'observacao',
                ]) !!}
