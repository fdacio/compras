    ...
    <div class="card mb-2">
        ...
        <div class="card">
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    {!! Form::open([
                                        ...
                                        'method' => 'delete',
                                        'route' => ['requisicoes-compras-externas.del-item.destroy', $requisicao->id],
            ...
            <div class="card-footer">
                <a href="{{ route('requisicoes-compras-externas.gera.pdf', $requisicao->id) }}" class="btn btn-success"
