...
<div class="card">
            ...
            <div class="stepwizard" style="margin-top: 20px;">
                <div class="stepwizard-row setup-panel">
                    <div class="stepwizard-step">
                        <a href="{{ route('requisicoes-compras-externas.edit', $requisicao->id) }}" class="btn btn-primary btn-circle"><i
    ...
    {!! Form::open(array('id' => 'form_requisicao_compra', 'method' => 'patch', 'route' => ['requisicoes-compras-externas.update', $requisicao->id])) !!}
