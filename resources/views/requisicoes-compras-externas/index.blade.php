...
@section('content')
    <div class="card mb-2">
        ...
        <div class="card-body">
            <form action="{{ route('requisicoes-compras-externas.index') }}" method="get" class="form-filter">
                <div class="row">
        ...
        <div class="card-footer">
            <div class="text-right mb-2">
                <a href="{{ route('requisicoes-compras-externas.create') }}" class="btn btn-primary"><i
                    ...
                    @foreach ($requisicoes as $requisicao)
                        <tr>
                            ...
                            <td class="text-right text-nowrap">
                                ...
                                <a href="{{ route('requisicoes-compras-externas.show', $requisicao->id) }}"
                                ...
                                {!! Form::open([
                                    ...
                                    'method' => 'put',
                                    'route' => ['requisicoes-compras-externas.cancelar', $requisicao->id],
                                    'style' => 'display: inline',
