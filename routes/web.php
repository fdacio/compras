...
Route::group(['middleware' => ['auth', 'auth.access', 'check.permissao']], function () {
    ...
    Route::delete('cotacoes/fornecedor/{cotacaoFornecedor}', 'CotacoesController@destroyFornecedor', ['parameters' => ['cotacoes-fornecedores' => 'cotacaoFornecedor']])->name('cotacoes.fornecedor.destroy');   
